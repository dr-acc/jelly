defmodule JellyWeb.Router do
  ...
  scope "/", JellyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{JellyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", JellyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{JellyWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", JellyWeb do
    ...
    live_session :current_user,
      on_mount: [{JellyWeb.UserAuth, :mount_current_user}] do
